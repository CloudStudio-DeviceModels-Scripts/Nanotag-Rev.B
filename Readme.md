...
# Parsing Script – Nanotag - Rev. B

This **Parsing** script is designed for the **Nanotag** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing – Nanotag Rev. B

Este script de **Parsing** está diseñado para el modelo **Nanotag** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
